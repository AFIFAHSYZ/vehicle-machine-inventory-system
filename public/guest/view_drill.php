    ...
    <main class="main">
        <div class="header">
            ...
            <div class="actions">
                ...
                <a class="btn secondary" href="view_machine.php">&nbsp;View Machine</a>
 </div>
        </div>
            ...
            <?php if ($totalPages > 1): ?>
                <div class="pagination">
                    ...
                    <div class="page-links">
                        ...
                        $prevHref = "view_drill.php?" . buildQuery(["page" => max(1, $page - 1)]);
                        $nextHref = "view_drill.php?" . buildQuery(["page" => min($totalPages, $page + 1)]);
                        ?>
                        ...
                        for ($p = $start; $p <= $end; $p++):
                            $href = "view_drill.php?" . buildQuery(["page" => $p]);
                        ?>
